...
public class DatabaseStorage implements EmployeeStorageRepository {
    ...
    public boolean store(HashMap<String, Employee> employeeMap, HashMap<String, String> worksUnderMap) {
        ...
        return EmployeeDAO.getInstance().storeDatabase(employeeTOList.toArray(new EmployeeTO[0]));
    }
    ...
    public HashMap[] load() {
        ...
        EmployeeTO[] employeeTOS = EmployeeDAO.getInstance().loadDatabase();
